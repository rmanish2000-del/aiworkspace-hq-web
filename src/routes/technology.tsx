  ...
  return (
    <>
      ...
      <Section heading="The exit strategy came first" id="exit-heading">
        <LedgerBlock id="CB-32" className="max-w-2xl text-[0.9375rem] leading-relaxed text-muted-foreground" />
      </Section>

      <Section heading="The six technologies" id="stack-heading">
        <div className="max-w-2xl text-[0.9375rem] leading-relaxed text-muted-foreground">
      ...
      <Section heading="What we rejected" id="rejected-heading">
        <TermList
      ...
      <Section heading="How we decide" id="decide-heading">
        <LedgerBlock id="CB-39" className="max-w-2xl text-[0.9375rem] leading-relaxed text-muted-foreground" />
      </Section>

      <Section heading="A stated ceiling" id="ceiling-heading">
        <LedgerBlock id="CB-37" className="max-w-2xl text-[0.9375rem] leading-relaxed text-muted-foreground" />
      </Section>
