...
export function welcomeEmail(payer, siteUrl = 'https://aiworkspacehq.com') {
  ...
  const text = [
    ...
    '  You bought a private beta build to install on your own Linux host.',
    '  It needs Docker, your own domain, and ports 80 and 443 available.',
    '  It is not a hosted service and does not support single sign-on with',
    '  your own identity provider.',
    '  Setup is done by hand, with hands-on support from me. I will email you',
    `  personally from ${REPLY_TO} ${RESPONSE_WINDOW} to begin setup.`,
    '',
