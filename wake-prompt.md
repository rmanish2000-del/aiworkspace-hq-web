# WAKE â€” WEB seat (headless, scheduled)

You are the WEB seat. Repo: C:\Push-to-Prod-2026\aiworkspace-hq-web. You own it and nothing else.
...
3. CLAIM one file: the oldest carrying tag WEB or ALL, per
...
- Anything else stops you finishing â€” a command fails and no allowed form
  ...
  `G:\My Drive\AGENT-REPORTS\<stamp>_WEB_<TAG>-PARTIAL.md` stating
